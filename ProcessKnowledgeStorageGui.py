...
class ProcessKnowledgeStoragePanel:
    def __init__(self):
        ...
        # Item7
        self.keyLabel7 = QtGui.QLabel('制造工艺')
        ...
        # Item8
        self.keyLabel8 = QtGui.QLabel('生产公司')
        ...
        self.mainLayout.addWidget(self.addItemButton, 8, 0, 2, 1)
    ...
    def on_addItemButton_clicked(self):
        # keyLineEdit = QtGui.QLineEdit()
        # keyLineEdit.setMaximumWidth(50)
        # keyLineEdit.setMinimumHeight(20)
        # valueLineEdit = QtGui.QLineEdit()
        # valueLineEdit.setMinimumWidth(50)
        # valueLineEdit.setMinimumHeight(20)
    ...
    def accept(self):
        ...
        # pathList = doc.FileName.split('/')
        # filePath = '/'.join(pathList[:-1])
        # fileName = pathList[-1]
        # pos = fileName.index('.FCStd')
...
class ProcessKnowledgeStorage:
    def Activated(self):
        panel = ProcessKnowledgeStoragePanel()
        FreeCADGui.Control.showDialog(panel)

    def GetResources(self):
        # icon and command information
        MenuText = QtCore.QT_TRANSLATE_NOOP(
            'ProcessKnowledgeStorage',
            'Process Knowledge Storage Dialog')
        ToolTip = QtCore.QT_TRANSLATE_NOOP(
            'ProcessKnowledgeStorage',
            'Store process knowledge as a JSON file')
        return {
            'Pixmap': __process_knowledge_storage_dir__ + '/icons/ProcessKnowledgeStorage_cmd.svg',
            'MenuText': MenuText,
            'ToolTip': ToolTip}
...
FreeCADGui.addCommand('ProcessKnowledgeStorage', ProcessKnowledgeStorage())
